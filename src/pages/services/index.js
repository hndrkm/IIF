import SideBarServices from "../../components/Page/Submenu/SideBarServices";
function Services() {
  return (
    <div className="w-full flex justify-center bg-gray-100">
      <div className="w-4/5 flex">
        ...
        <div className="flex flex-col w-3/4 bg-gray-100 mt-10">
          <div className="relative flex justify-center bg-gray-400 h-60 ">
            <div className="absolute -bottom-6 bg-gray-200 flex text-3xl p-4 rounded-md">
